 ...
 * the base separately as `@internal`, the public `YamlLexError` class
...
/**
 * Error raised when YAML lexing encounters one or more tokenization errors.
 *
 * @remarks
 ...
 * each problem found.
 *
 * @see {@link lex} — may produce tokens that cause this error downstream
 *
